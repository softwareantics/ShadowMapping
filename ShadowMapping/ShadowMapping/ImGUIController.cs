// <copyright file="ImGUIController.cs" company="Software Antics">
...
void main()
{
    ...
    public void RecreateFontDeviceTexture()
    {
        ...
        io.Fonts.SetTexID((nint)this._fontTexture);
    ...
    private void UpdateImGuiInput(KeyboardState keyboard, MouseState mouse)
    {
        ...
        var screenPoint = new Vector2i((int)window.MousePosition.X, (int)this.window.MousePosition.Y);
